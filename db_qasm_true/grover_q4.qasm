...
gate gate_Q_2004276013504 q0,q1,q2,q3 { gate_Q q0,q1,q2,q3; }
gate gate_Q_2004276016240 q0,q1,q2,q3 { gate_Q q0,q1,q2,q3; }
qreg q[3];
qreg flag[1];
creg meas[4];
h q[0];
...
h q[2];
x flag[0];
gate_Q_2004276013504 q[0],q[1],q[2],flag[0];
gate_Q_2004276016240 q[0],q[1],q[2],flag[0];
